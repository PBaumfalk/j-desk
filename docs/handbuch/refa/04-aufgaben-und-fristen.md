...
Rechtsklick auf freie Fläche und eine Aufgabe anlegen. Sie erscheint als Karte auf dem
Tisch — dort, wo die Arbeit hingehört, also gern neben dem Dokument, um das es geht.

Anschließend per **Rechtsklick auf die Aufgabenkarte**:

| Menüpunkt | Wofür |
|---|---|
| **Fällig am…** | Datum eintragen |
...
**Rechtsklick auf die Aufgabe → „An j-lawyer übergeben"**
...
> an einer. Nach der Übergabe pflegen Sie sie in j-lawyer weiter.

---

## Wie behalte ich den Überblick?

**Was steht noch offen?** Über **Schreibtisch-Menü → „Übergabe…"** gibt es eine
**Aufgabenliste** als eigene Zusammenstellung — praktisch für die Wochenbesprechung oder
die Übergabe an eine Kollegin.
...
**Was hat sich getan?** Die **Historie** (obere Leiste) zeigt, wer wann was geändert hat.
