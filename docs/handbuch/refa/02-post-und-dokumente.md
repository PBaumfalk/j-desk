...
hochladen, was dort schon liegt.

**Was Sie tun, wenn ein Dokument noch nicht auf dem Tisch liegt:** Es über die
Dokumentliste der Akte dazuholen. Es entsteht dabei **keine Kopie** — die Karte verweist
...
**Rechtsklick auf freie Fläche → „Inhalt aufnehmen…"**

Damit holen Sie Dinge in die Akte, die nicht als Dokument aus j-lawyer kommen:

| Art | Wofür |
|---|---|
| **Weblink** | Eine Fundstelle im Netz. Wird **immer als externe Referenz** aufgenommen, nie kopiert |
| **Urteil** | Mit Gericht, Aktenzeichen und Datum |
| **Norm** | Mit Gesetz und Paragraf |
| **E-Mail** | Ein Nachrichtenverlauf |
| **Foto** | Vom Handy oder aus dem Dateisystem |
| **Audio oder Video** | Aufnahmen |
| **Textfragment** | Ein Stück Text, das Sie irgendwoher haben |

Beim Aufnehmen entscheiden Sie unter **„Ablage"**, ob der Inhalt in j-lawyer abgelegt wird
oder nur als **externe Referenz** vermerkt bleibt.

> **Wichtig für die Akte:** Ein Weblink kann sich ändern oder verschwinden. Wenn der Inhalt
> beweiserheblich ist, legen Sie ihn besser als Datei ab, statt nur zu verlinken.
