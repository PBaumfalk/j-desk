...
export interface Stamp {
  ...
  baseH: number;
  createdBy?: string;    // Provenienz: wer hat den Stempel erzeugt; fehlt in Alt-States
...
export function addStamp(s: DesktopState, stamp: Omit<Stamp, 'id'> & { id?: string }, meta?: CommandMeta): DesktopState {
